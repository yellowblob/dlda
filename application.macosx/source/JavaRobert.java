...
public class JavaRobert extends PApplet {
...
float[] playerProbability = {0.333f,0.167f,0.333f,0.167f};
int[] fixedPlayers = {3,2,1,0,2,0,2,0,2,2,0,0,0};
JSONArray sequencesJSON;

int green = color(0,255,0);
int red = color(255,0,0);
int serialControlColor = red;
...
public void oscEvent(OscMessage theOscMessage) {
  ...
  if (theOscMessage.checkAddrPattern("/buzz")==true){
    ...
    scene = PApplet.parseInt(theOscMessage.get(0).floatValue()); // get the first osc argument
    buzzCount = 0;
    updatePlaybackController();
  }
}
...
public void updatePlaybackController () {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "JavaRobert" };
    if (passedArgs != null) {
